...
public class C01_StringManipulations {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("result5 = " + result5);// indexQYX =-1 olmayan sey aratilinca-1
...
// Ex : Bir String'de "java" kelimesinin  ilk olarak kacinci index'de oldugunu gosteren
       ...
       int indexJava= cumle.indexOf("Java");
        ...
        System.out.println("indexQYX = " + indexQYX);// indexQYX =-1 olmayan bir sey araninca -1 gelir
